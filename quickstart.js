...
// sudo npm install csv-write-stream
var csvWriter = require('csv-write-stream');
var writer = csvWriter({
        separator: ',',
        newline: '\n',
        headers: ["date", "color1", "color2"],
        sendHeaders: false
      });

// https://www.npmjs.com/package/node-stringify
// sudo npm install node-stringify --save
  ...
  sheets.spreadsheets.values.get({
    ...
    */
    ...
    if (rows.length == 0) {
      ...
      console.log('spreadsheet records');
      ...
      for (var i = 0; i < rows.length; i++) {
        ...
        //var stringified = stringify( row[0] );

        //console.log('stringified : %s', stringified);

        writer.write([ stringify(row[0]), stringify(row[1]), stringify(row[2]) ]);
      }
